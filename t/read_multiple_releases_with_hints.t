...
my $changes = CPAN::Changes->load( 't/corpus/multiple_releases_with_hints.changes' );
...
is( $releases[ 0 ]->hint,    'update not required', 'hint' );
is_deeply(
    $releases[ 0 ]->changes,
    { '' => [ 'Initial release' ] },
    'full changes'
...
is( $releases[ 1 ]->hint,    'update recommended', 'hint' );
is_deeply(
    $releases[ 1 ]->changes,
    { '' => [ 'New version' ] },
    'full changes'
